...
private:
     ...
     */
    void computeAccelerations_opt_2(queue &queue, buffer<double> &masses, buffer<double> &currentPositions_x,
    ...
    /*
     * Computes the acceleration of each body induced by the gravitation of all the other bodies.
     * In contrast to computeAccelerations_opt_0 it splits up the work into work-groups, but it does not use
     * local memory like computeAccelerations_opt_2.
     */
    void computeAccelerations_opt_1(queue &queue, buffer<double> &masses, buffer<double> &currentPositions_x,
                                 buffer<double> &currentPositions_y, buffer<double> &currentPositions_z,
                                 buffer<double> &acceleration_x, buffer<double> &acceleration_y,
                                 buffer<double> &acceleration_z);
    ...
    /*
     * Computes the acceleration of each body induced by the gravitation of all the other bodies.
     * In contrast to computeAccelerations_opt_{1,2} it does not implement the optimizations for GPU execution.
     */
    void computeAccelerations_opt_0(queue &queue, buffer<double> &masses, buffer<double> &currentPositions_x,
                                    buffer<double> &currentPositions_y, buffer<double> &currentPositions_z,
                                    buffer<double> &acceleration_x, buffer<double> &acceleration_y,
                                    buffer<double> &acceleration_z);
};

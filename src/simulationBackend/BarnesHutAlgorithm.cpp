...
void BarnesHutAlgorithm::computeMinMaxValuesAABBParallel(queue &queue, buffer<double> &current_positions_x,
                                                         buffer<double> &current_positions_y,
                                                         buffer<double> &current_positions_z) {

    int threadCount = 100;
    int bodiesPerThread = ceil(numberOfBodies / threadCount);
    ...
    buffer<double> localMax_X = localMax_X_vec;
    buffer<double> localMax_Y = localMax_Y_vec;
    buffer<double> localMax_Z = localMax_Z_vec;
    ...
    buffer<double> localMin_X = localMin_X_vec;
    buffer<double> localMin_Y = localMin_Y_vec;
    buffer<double> localMin_Z = localMin_Z_vec;
    ...
    queue.submit([&](handler &h) {
        ...
        h.parallel_for(threadCount, [=](auto &idx) {
